...
#ifndef TRANSLATEREADER_SWIFT_H
#define TRANSLATEREADER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TranslateReader",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSXMLParser;
@class NSString;
SWIFT_CLASS("_TtC15TranslateReader15ContainerParser")
@interface ContainerParser : NSObject <NSXMLParserDelegate>
...
SWIFT_CLASS("_TtC15TranslateReader9OPFParser")
@interface OPFParser : NSObject <NSXMLParserDelegate>
- (void)parser:(NSXMLParser * _Nonnull)parser didStartElement:(NSString * _Nonnull)elementName namespaceURI:(NSString * _Nullable)namespaceURI qualifiedName:(NSString * _Nullable)qName attributes:(NSDictionary<NSString *, NSString *> * _Nonnull)attributeDict;
...
SWIFT_CLASS("_TtC15TranslateReader13SpeechService")
...
@interface SpeechService (SWIFT_EXTENSION(TranslateReader)) <AVSpeechSynthesizerDelegate>
